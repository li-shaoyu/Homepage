...
CREATE TABLE `kkb_user` (
	...
	`niuke` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '牛客网号码',
	`github` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT 'github号码',
	`CSDN` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT 'CSDN地址',
